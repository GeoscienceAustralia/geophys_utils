...
-- Started on 2018-07-19 15:11:08
...
-- Dependencies: 2870
-- Name: DATABASE dataset_metadata_cache; Type: COMMENT; Schema: -; Owner: postgres
--

COMMENT ON DATABASE dataset_metadata_cache IS 'Database to cache dataset metadata sourced from CSW queries';
...
--
-- TOC entry 1 (class 3079 OID 27016)
...
--
-- TOC entry 197 (class 1259 OID 29452)
...
--
-- TOC entry 203 (class 1259 OID 29473)
...
--
-- TOC entry 201 (class 1259 OID 29464)
...
--
-- TOC entry 199 (class 1259 OID 29458)
...
--
-- TOC entry 204 (class 1259 OID 29518)
...
--
-- TOC entry 205 (class 1259 OID 29524)
...
--
-- TOC entry 206 (class 1259 OID 29527)
-- Name: distribution_protocol_protocol_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.distribution_protocol_protocol_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.distribution_protocol_protocol_id_seq OWNER TO postgres;

--
-- TOC entry 2896 (class 0 OID 0)
-- Dependencies: 206
-- Name: distribution_protocol_protocol_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.distribution_protocol_protocol_id_seq OWNED BY public.protocol.protocol_id;


--
-- TOC entry 200 (class 1259 OID 29461)
...
--
-- TOC entry 198 (class 1259 OID 29455)
...
--
-- TOC entry 202 (class 1259 OID 29467)
...
--
-- TOC entry 2698 (class 2604 OID 29475)
...
--
-- TOC entry 2704 (class 2604 OID 29520)
...
--
-- TOC entry 2705 (class 2604 OID 29529)
-- Name: protocol protocol_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.protocol ALTER COLUMN protocol_id SET DEFAULT nextval('public.distribution_protocol_protocol_id_seq'::regclass);


--
-- TOC entry 2703 (class 2604 OID 29469)
...
--
-- TOC entry 2855 (class 0 OID 29452)
-- Dependencies: 197
-- Data for Name: dataset; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.dataset (dataset_id, dataset_title, survey_id, longitude_min, longitude_max, latitude_min, latitude_max, convex_hull_polygon, metadata_uuid) FROM stdin;
\.


--
-- TOC entry 2859 (class 0 OID 29464)
-- Dependencies: 201
-- Data for Name: dataset_keyword; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.dataset_keyword (dataset_id, keyword_id) FROM stdin;
\.


--
-- TOC entry 2857 (class 0 OID 29458)
-- Dependencies: 199
-- Data for Name: distribution; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.distribution (distribution_id, dataset_id, distribution_url, protocol_id) FROM stdin;
\.


--
-- TOC entry 2858 (class 0 OID 29461)
-- Dependencies: 200
-- Data for Name: keyword; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.keyword (keyword_id, keyword_value, keyword_url) FROM stdin;
\.


--
-- TOC entry 2863 (class 0 OID 29524)
-- Dependencies: 205
-- Data for Name: protocol; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.protocol (protocol_id, protocol_value) FROM stdin;
\.


--
-- TOC entry 2856 (class 0 OID 29455)
-- Dependencies: 198
-- Data for Name: survey; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.survey (survey_id, ga_survey_id, survey_name) FROM stdin;
\.
...
-- Dependencies: 204
-- Name: distribution_distribution_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.distribution_distribution_id_seq', 1, false);


--
-- TOC entry 2908 (class 0 OID 0)
-- Dependencies: 206
-- Name: distribution_protocol_protocol_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.distribution_protocol_protocol_id_seq', 1, false);
...
--
-- TOC entry 2722 (class 2606 OID 29499)
...
--
-- TOC entry 2707 (class 2606 OID 29483)
...
--
-- TOC entry 2714 (class 2606 OID 29538)
...
--
-- TOC entry 2718 (class 2606 OID 29497)
...
--
-- TOC entry 2720 (class 2606 OID 29495)
...
--
-- TOC entry 2699 (class 2606 OID 29516)
...
--
-- TOC entry 2700 (class 2606 OID 29517)
...
--
-- TOC entry 2701 (class 2606 OID 29514)
...
--
-- TOC entry 2702 (class 2606 OID 29515)
...
--
-- TOC entry 2726 (class 2606 OID 29534)
...
--
-- TOC entry 2728 (class 2606 OID 29536)
...
--
-- TOC entry 2710 (class 2606 OID 29487)
...
--
-- TOC entry 2712 (class 2606 OID 29485)
...
--
-- TOC entry 2723 (class 1259 OID 29505)
...
--
-- TOC entry 2724 (class 1259 OID 29511)
...
--
-- TOC entry 2708 (class 1259 OID 29493)
...
--
-- TOC entry 2715 (class 1259 OID 29544)
...
--
-- TOC entry 2716 (class 1259 OID 29550)
...
--
-- TOC entry 2732 (class 2606 OID 29500)
...
--
-- TOC entry 2733 (class 2606 OID 29506)
...
--
-- TOC entry 2729 (class 2606 OID 29488)
...
--
-- TOC entry 2730 (class 2606 OID 29539)
...
--
-- TOC entry 2731 (class 2606 OID 29551)
...
-- Completed on 2018-07-19 15:11:08
