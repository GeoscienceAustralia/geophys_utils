...
class ASEGGDF2NetCDFConverter(ToNetCDFConverter):
    ...
    def __init__(self, 
        ...
        def get_field_definitions():
            ...
            if not lat_field_definition:
                fatal_parsing_error(dfn_path, 'No field definition of LATITUDE found.  LATITUDE is a required field.')

            if not lng_field_definition:
                fatal_parsing_error(dfn_path, 'No field definition of LONGITUDE found.  LONGITUDE is a required field.')
