...
class NetCDF2kmlConverter(object):
    ...
    def build_points(self, points_folder, bounding_box):
        ...
        if True in spatial_mask:
            ...
            # point_stylz = simplekml.Style()
            # point_stylz.iconstyle.scale = self.point_style.iconstyle.scale
            # point_stylz.labelstyle.scale = self.point_style.labelstyle.scale
            # point_stylz.iconstyle.icon.href = self.point_style.iconstyle.icon.href
            ...
            for point_data_list in point_data_generator:
                ...
                # set the styles that are consistent between points (all but colour)
